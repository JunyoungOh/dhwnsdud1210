...
const ManageTab = ({
  ...
  const PAGE_SIZE   = 10;
  const MAX_BTN     = 10; // 화면에 보이는 숫자 버튼 개수
  ...
  const [groupStart, setGroupStart] = useState(1); // 현재 버튼 그룹 시작 페이지(1, 11, 21 ...)
...
export default function App() {
  ...
  const [activeTab, setActiveTab]   = useState(TAB_PAGE.ALERTS);
